...
builtin_time_grains: dict[str | None, str] = {
    TimeGrainConstants.SECOND: "Second",
    TimeGrainConstants.FIVE_SECONDS: "5 second",
    TimeGrainConstants.THIRTY_SECONDS: "30 second",
    TimeGrainConstants.MINUTE: "Minute",
    TimeGrainConstants.FIVE_MINUTES: "5 minute",
    TimeGrainConstants.TEN_MINUTES: "10 minute",
    TimeGrainConstants.FIFTEEN_MINUTES: "15 minute",
    TimeGrainConstants.THIRTY_MINUTES: "30 minute",
    TimeGrainConstants.HOUR: "Hour",
    TimeGrainConstants.SIX_HOURS: "6 hour",
    TimeGrainConstants.DAY: "Day",
    TimeGrainConstants.WEEK: "Week",
    TimeGrainConstants.MONTH: "Month",
    TimeGrainConstants.QUARTER: "Quarter",
    TimeGrainConstants.YEAR: "Year",
    TimeGrainConstants.WEEK_STARTING_SUNDAY: "Week starting Sunday",
    TimeGrainConstants.WEEK_STARTING_MONDAY: "Week starting Monday",
    TimeGrainConstants.WEEK_ENDING_SATURDAY: "Week ending Saturday",
    TimeGrainConstants.WEEK_ENDING_SUNDAY: "Week ending Sunday",
}
